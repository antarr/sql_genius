...
RSpec.describe(SqlGenius::Core::Analysis::Columns) do
  subject(:service) do
    described_class.new(
      connection,
      blocked_tables: [],
  ...
  let(:users_columns) do
    [
      ...
      SqlGenius::Core::ColumnDefinition.new(name: "email",         sql_type: "varchar(255)", type: :string,   null: false, default: nil, primary_key: false),
      SqlGenius::Core::ColumnDefinition.new(name: "password_hash", sql_type: "varchar(255)", type: :string,   null: false, default: nil, primary_key: false),
      SqlGenius::Core::ColumnDefinition.new(name: "api_token",     sql_type: "varchar(64)",  type: :string,   null: true,  default: nil, primary_key: false),
      SqlGenius::Core::ColumnDefinition.new(name: "created_at",    sql_type: "datetime",     type: :datetime, null: false, default: nil, primary_key: false),
      SqlGenius::Core::ColumnDefinition.new(name: "updated_at",    sql_type: "datetime",     type: :datetime, null: false, default: nil, primary_key: false),
    ]
  end
