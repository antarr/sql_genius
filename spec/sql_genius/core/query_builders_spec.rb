...
RSpec.describe(SqlGenius::Core::QueryBuilders) do
  ...
  describe ".for" do
    it "returns the Mysql builder for a MySQL connection" do
      ...
      expect(described_class.for(connection)).to(be(SqlGenius::Core::QueryBuilders::Mysql))
    end
    ...
    it "returns the Postgresql builder for a PostgreSQL connection" do
      ...
      expect(described_class.for(connection)).to(be(SqlGenius::Core::QueryBuilders::Postgresql))
    end
  end

  describe SqlGenius::Core::QueryBuilders::Postgresql do
    let(:connection) do
