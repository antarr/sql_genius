...
RSpec.describe(SqlGenius::Core) do # rubocop:disable RSpec/SpecFilePathFormat
  describe ".views_path" do
    it "returns an absolute path" do
      expect(described_class.views_path).to(start_with("/"))
    end

    it "points at lib/sql_genius/core/views relative to the core gem" do
      expect(described_class.views_path).to(end_with("lib/sql_genius/core/views"))
    end
